...
moduleForComponent('reports/assessment/questions/qz-hs-text', 'Unit | Component | reports/assessment/questions/qz hs text', {
  integration: false
});
...
test('answers show correct answer', function(assert) {
  ...
  assert.equal(component.get('answers')[0].text,'An aquifer','Incorrect text');
