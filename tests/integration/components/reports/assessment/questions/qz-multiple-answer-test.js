...
test('Multiple Answer Correct Answer', function(assert) {
  ...
  this.render(hbs`{{reports/assessment/questions/qz-multiple-answer question=question showCorrect=showCorrect}}`);
  const $component = this.$(); //component dom element
  const $multipleAnswer = $component.find('.reports.assessment.questions.qz-multiple-answer');
...
test('Multiple Answer Your Answer Incorrect', function(assert) {
  let userAnswer = Ember.A([{ value: '3' }]);
  let questionResult = QuestionResult.create({
    resource: ResourceModel.create({
      id: '569906aa20b7dfae1bcd5',
      type: 'multiple_choice',
  ...
  this.render(hbs`{{reports/assessment/questions/qz-multiple-answer question=question userAnswer=userAnswer}}`);
  const $component = this.$(); //component dom element
  const $multipleAnswer = $component.find('.reports.assessment.questions.qz-multiple-answer');
...
test('Multiple Answer Your Answer Correct', function(assert) {
  let userAnswer = Ember.A([{ value: '2' }, { value: '3' }]);
  let questionResult = QuestionResult.create({
    resource: ResourceModel.create({
      id: '569906aa20b7dfae1bcd5',
      type: 'multiple_choice',
...
test('Multiple Answer anonymous', function(assert) {
  ...
  this.render(hbs`{{reports/assessment/questions/qz-multiple-answer question=question userAnswer=userAnswer anonymous=true}}`);
  const $component = this.$(); //component dom element
  const $multipleAnswer = $component.find('.reports.assessment.questions.qz-multiple-answer');
