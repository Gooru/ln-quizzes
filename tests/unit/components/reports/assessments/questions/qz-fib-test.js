...
test('answers show correct answer', function(assert) {
  ...
  assert.equal(component.get('answer')[0].text,'The mountain is ','Incorrect text');
  ...
  assert.equal(component.get('answer')[1].class,'answer correct','Incorrect class,should be correct');
});
...
test('answers show user answer correct', function(assert) {
  ...
  assert.equal(component.get('answer')[0].class,'sentence','Incorrect class');
  assert.equal(component.get('answer')[1].text,'green','Incorrect text');
  assert.equal(component.get('answer')[1].class,'answer correct','Class should be correct');
});
