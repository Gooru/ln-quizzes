export default {
  ...
  "common": {
    ...
    "errors": {
      ...
      "available-date-error":"Please enter the available date",
      ...
      "due-date-error":"The due date should be greater than the available date",
      "due-date-presence-error":"Please enter the due date",
