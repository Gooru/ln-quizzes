...
moduleForComponent('reports/class-assessment/qz-question-information', 'Integration | Component | reports/class assessment/qz question information', {
  integration: true
});
...
test('Question Information With Narration Hints Explanation Media', function(assert) {
  ...
  this.render(hbs`{{reports/class-assessment/qz-question-information question=question}}`);
...
test('Question Information Anonymous', function(assert) {
  ...
  this.render(hbs`{{reports/class-assessment/qz-question-information question=question anonymous=anonymous}}`);
