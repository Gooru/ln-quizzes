...
test('Table layout student', function(assert) {
  ...
  assert.ok($assignmentTable.find('.gru-assignments-table table thead tr th.attempts-header.hidden-xs').length, 'Missing Attempts Header');
  assert.ok($assignmentTable.find('.gru-assignments-table table thead tr th.attempts-header.visible-xs').length, 'Missing Mobile Attempts Header');
  ...
  assert.ok($assignmentTable.find('.gru-assignments-table table thead tr th.options-header.visible-xs ').length, 'Missing Mobile Options Header');
  ...
  assert.ok($assignmentTable.find('.gru-assignments-table table tbody tr td.actions.visible-xs').length,'Missing mobile actions column');
...
test('Table layout teacher', function(assert) {
  ...
  assert.ok($assignmentTable.find('.gru-assignments-table table thead tr th.students-assigned-header.hidden-xs').length, 'Missing Students Assigned Header');
  assert.ok($assignmentTable.find('.gru-assignments-table table thead tr th.students-assigned-header.visible-xs').length, 'Missing Mobile Students Assigned Header');
