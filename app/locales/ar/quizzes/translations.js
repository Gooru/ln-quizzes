   ...
   */  
   "common":{  
      ...
      "errors":{  
         ...
         "reset-google-account-exists":"لقد تم إنشاء حسابك لدينا باستخدام حساب جوجل، ولا يمكننا إعادة تعيين كلمة المرور الخاصة به. إذا نسيت كلمة المرور الخاصة بحساب جوجل، يجب عليك إعادة تعيينها عن طريق تطبيقات جوجل.",
   ...
   "sign-up":{  
      ...
      "error-email-taken":"هذا البريد الاكتروني مستخدم من قبل شخص آخر, جرّب بريداً آخر.",
   ...
   "footer":{  
      "footerDescription":"نلتزم في جورو بالحفاظ على منصة المصادر المفتوحة ومحتوى المجموعات الناشئة CC0. ",
      "company":"الشركة",
      "community":"المجتمع",
      "legal":"قانوني",
      "connect":"الاتصال",
   ...
   "gru-image-picker":{  
      ...
      "restriction":"يجب أن تكون الصورة بصيغة  JPG أو GIF أو PNG وحجمها أقل من 5 MB.",
   ...
   "gru-tour":{  
      ...
      "home":{  
         "stepOne":{  
            ...
            "description":"مرحبا بكم في صفحة جورو الخاصة بك! هنا يمكنك العثور على قائمة من الصفوف الدراسية التي تقوم بإنشائها في جورو. تتيح لك الفصول الدراسية مشاركة المحتوى مباشرة مع الطلاب. ويمكنك دائما العودة إلى صفحتك الرئيسية من خلال النقر على أيقونة جورو."
         },
         "stepTwo":{  
            "title":"صفوف تدرّسها أو منضمّ إليها",
            "description":"ستظهر أي غرف صفية تدرسها أو تنضم إليها خلال هذا العام الدراسي هنا تحت الصفوف الدراسية النشطة."
         },
         "stepThree":{  
         ...
         "stepFour":{  
            "title":"أنشئ صف دراسي",
            "description":"انقر هنا لإنشاء صف دراسي جديد. بمجرد أن يصبح لديك محتوى لمشاركته مع الطلاب، سوف تقوم بتعيينه لهم عبر صفٍ دراسي."
         },
         "stepFive":{  
            "title":"ملفك الشخصي",
            "description":"هذا هو ملفك الشخصي. انقر على ملفك الشخصي في أي وقت للوصول إلى المحتوى الذي تقوم بإنشائه أو إعادة مزجه في جورو."
         }
      }
   },
   "assign-students":{  
