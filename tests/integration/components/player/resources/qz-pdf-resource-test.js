...
moduleForComponent('player/resources/qz-pdf-resource', 'Integration | Component |  player/resources/qz pdf resource', {
  integration: true
});
test('PDF player layout', function (assert) {
  ...
  T.exists(assert, $component.find(".qz-pdf-resource iframe"), "Missing pdf resource element");
