...
moduleForComponent('reports/assessment/questions/qz-hot-text-highlight', 'Integration | Component | reports/assessment/questions/qz-hot-text-highlight', {
  integration: true
});
...
test('Hot Text Highlight User Answer', function(assert) {
  ...
  var userAnswer = [{ value: 'Sentence 2.,12' }, { value: 'Sentence 3.,24' }, { value: 'Sentence 4.,36' }];
  ...
  assert.equal($incorrectAnswers.length, 1, 'There are no incorrect answers, there should be 1');
});
