window.qzi18n = {
  ...
  'common.add': 'ചേർക്കുക',
  'common.add-assessment': 'പുതിയ വിലയിരുത്തൽ ചേർക്കുക',
  ...
  'common.add-content-prompt':
    'നിങ്ങൾ ഇതുവരെ സൃഷ്ടിച്ചില്ല <span> {{type}} </span>. ധൈര്യമായിരിക്കുക.',
  ...
  'common.assessment-task': 'മൂല്യനിർണയം',
  ...
  'common.assign-to-class': 'ക്ലാസ് നൽകുക',
  ...
  'common.content-publishing': 'ഉള്ളടക്ക ദൃശ്യപരത',
  ...
  'common.create-class': '+ ക്ലാസ്റൂം സൃഷ്ടിക്കുക',
  ...
  'common.errors.assignees-error':
    'അസൈന്മെന്റ് സൃഷ്ടിക്കുന്നതിന് കുറഞ്ഞത് ഒരു വിദ്യാർത്ഥിയെങ്കിലും നിങ്ങൾ തിരഞ്ഞെടുക്കണം.',
  'common.errors.available-date-error': 'ലഭ്യമായ തീയതി നിങ്ങൾ പൂർത്തിയാക്കണം',
  ...
  'common.errors.due-date-error':
    'നിലവിലുള്ള തീയതി ലഭ്യമായ തീയതിയിൽ കൂടുതലായിരിക്കണം',
  'common.errors.due-date-presence-error':
    'നിശ്ചിത തീയതി പൂർത്തിയാക്കിയിരിക്കണം',
  ...
  'common.errors.username-length':
    'ഉപയോക്തൃനാമം 4 നും 16 നും ഇടയിലുള്ളതായിരിക്കണം.',
  ...
  'common.learning-objective': 'പഠന ലക്ഷ്യം',
  ...
  'common.link-out-message':
    '* നിങ്ങളുടെ റിസോഴ്സ് മുകളിൽ പ്രിവ്യൂയിൽ റെൻഡർ ചെയ്യുന്നില്ലെങ്കിൽ, ഇതിന് ഒരു "ലിങ്ക്-ഔട്ട്" ആവശ്യമുണ്ട്, ഒപ്പം ഗോര പ്ലെയറിൽ തന്നെ കാണാനും കഴിയില്ല.',
  ...
  'common.modify-settings': 'വിലയിരുത്തൽ ക്രമീകരണങ്ങൾ പരിഷ്ക്കരിക്കുക',
  'common.move': 'നീങ്ങുക',
  ...
  'common.no-assessments-to-display':
    'ഇല്ല <span> വിലയിരുത്തലുകൾ നടത്താൻ </span>.',
  'common.no-collections-to-display':
    'പ്രദർശിപ്പിക്കുന്നതിനായി <span> ശേഖരങ്ങൾ </span> ഇല്ല.',
  'common.no-courses-to-display':
    'ഇല്ല <span> കോഴ്സുകൾ </span> പ്രദർശിപ്പിക്കുക.',
  'common.no-questions-to-display': 'പ്രദർശിപ്പിക്കുക <span> ചോദ്യങ്ങൾ.',
  'common.no-resources-to-display':
    'ഇല്ല <span> പ്രദർശിപ്പിക്കാൻ റിസോഴ്സുകൾ </span>.',
  ...
  'common.no-results-message':
    'നിങ്ങളുടെ അക്ഷരപ്പിശക് പരിശോധിക്കുക. ഞങ്ങൾ എല്ലാവരും തെറ്റുകൾ വരുത്തുന്നു! <br/> വിശാലമായ പോയി കുറെ ഫിൽട്ടറുകൾ നീക്കം ചെയ്യുക. അല്ലെങ്കിൽ സമാനമായ പദം തിരയാൻ ശ്രമിക്കുക.',
  ...
  'common.question-type.single_choice': 'ഒരൊറ്റ നിര',
  'common.question-type.FIB': 'വിട്ട ഭാഗം പൂരിപ്പിക്കുക',
  'common.question-type.true_false': 'ശരിയോ തെറ്റോ',
  ...
  'common.remix-warning':
    'ഹെഡ്സ് അപ്പുകൾ! ഈ കോഴ്സിൽ വളരെയധികം ആകർഷണീയമായ ഉള്ളടക്കം ഉണ്ട്, കൂടാതെ പകർപ്പെടുക്കുന്നത് സമയമെടുക്കും. നിങ്ങൾക്ക് പ്രക്രിയ ആരംഭിക്കണമെന്ന് സ്ഥിരീകരിക്കുകയും 15 മിനിറ്റിനകം ഈ കോഴ്സിൻറെ കോപ്പി നിങ്ങളുടെ <b> പ്രൊഫൈലിൽ കണ്ടെത്തും. </b>',
  ...
  'common.student-submission-format':
    'വിദ്യാർത്ഥി സമർപ്പണ ഫോർമാറ്റ് (ഒന്ന് തിരഞ്ഞെടുക്കുക)',
  ...
  'content.questions.edit.best-practices':
    '<p> ഒരു ചോദ്യമാണ് വിദ്യാർത്ഥിയുടെ ഉത്തരം ആവശ്യമുള്ള ഒരു ഉറവിടം, കൂടാതെ നിങ്ങളുടെ വിദ്യാർത്ഥികൾ sbac, parcc, മറ്റ് വിലയിരുത്തലുകൾ എന്നിവയിൽ കാണുന്ന തരത്തിൽ വിവിധ തരത്തിലുള്ള ചോദ്യങ്ങളെ പിന്തുണയ്ക്കുന്നതിനായി വ്യത്യസ്ത തരത്തിലുള്ള ചോദ്യരീതി ഞങ്ങൾ വാഗ്ദാനം ചെയ്യുന്നു. </p> <p> വിദ്യാർത്ഥികൾക്ക് ഈ ചോദ്യങ്ങളുമായി നേരിട്ട് ബന്ധപ്പെടാനും അറിവ് തെളിയിക്കുന്നതിനുള്ള വിവിധ ഫോർമാറ്റുകൾ നൽകാനും നിങ്ങൾ ഉപയോഗിക്കുന്ന ചോദ്യങ്ങൾ. </p> <p> നിങ്ങളുടെ ചോദ്യങ്ങൾ, മാനദണ്ഡങ്ങൾ, മൈക്രോ-സ്റ്റാൻഡേർഡുകൾ, വെബ്ബ് എന്നിവയെക്കുറിച്ചുള്ള അറിവിന്റെ ആഴത്തിലേക്ക് ടാഗ് ചെയ്യുക. ടീച്ചർ ഡാഷ്ബോർഡിലൂടെ നിങ്ങളുടെ വിദ്യാർത്ഥികൾ ചോദ്യങ്ങളുമായി ഇടപെടുന്നതെങ്ങനെയെന്ന് നിങ്ങൾക്ക് കാണാൻ കഴിയും. </p>',
  ...
  'content.resources.edit.best-practices':
    'വീഡിയോകൾ, ഇൻട്രാക്ടീവ്സ്, വെബ്സൈറ്റുകൾ, ഇമേജുകൾ, ഗൂഗിൾ ഡോക്സ് എന്നിവയും അതിലേറെയും പോലുള്ള വിവിധ ഫോർമാറ്റുകളിലുള്ള മൾട്ടിമീഡിയ ഉള്ളടക്കം ഉറവിടങ്ങളാണ്. നിങ്ങളുടെ സ്വന്തം വിഭവങ്ങൾ ഉപയോഗിക്കുകയോ നിങ്ങളുടെ സ്വന്തം വിഭവങ്ങൾ ഉപയോഗിക്കുകയോ "വിഭവസമ്പന്നനായ" നേടുകയും ഗൊറുവിൽ ഞങ്ങളുടെ മതിയായ വിതരണത്തിൽ അന്വേഷിക്കുകയും ചെയ്യുക. </p> <p> നിങ്ങളുടെ വിദ്യാർത്ഥികളുമായി ഇടപഴകുന്നതിനും നിങ്ങളുടെ വിദ്യാർത്ഥികളെ പരിശീലിപ്പിക്കുന്നതിനുമായി വിവരണങ്ങളിൽ ഉൾപ്പെടുത്തിക്കൊണ്ട് വിവിധ വിഭവങ്ങളുടെ തരം പ്രയോജനപ്പെടുത്തുക. </p> <p> മാനദണ്ഡങ്ങൾ, മൈക്രോ- മാനദണ്ഡങ്ങൾ, 21-ാം നൂറ്റാണ്ടിലെ കഴിവുകൾ എന്നിവയിലേക്ക് ഓരോ ചോദ്യങ്ങൾക്കും ടാഗ് ചെയ്യണമെന്ന് ഞങ്ങൾ ശുപാർശ ചെയ്യുന്നു. ടീച്ചർ ഡാഷ്ബോർഡിലൂടെ നിങ്ങളുടെ വിദ്യാർത്ഥികൾ എങ്ങനെ വിഭവങ്ങളുമായി ഇടപഴകുന്നതെന്ന് നിങ്ങൾക്ക് കാണാം. </p>',
  'content.resources.edit.placeholder-message':
    'ഇതിന് ഒരു വിഭവം ചേർക്കുക <span> ഇത് ഇവിടെ പ്രിവ്യൂ ചെയ്യുക.',
  'content.resources.edit.not-implemented':
    'റിസോഴ്സ് ഫോർമാറ്റ് പ്രിവ്യൂ <span> ഇതുവരെ നടപ്പിലാക്കിയില്ല. </span>',
  ...
  'gru-add-to.assessments-info':
    'ഇവിടെ നൽകിയിരിക്കുന്ന മൂല്യനിർണ്ണയം <b> മറ്റൊരു പാഠം അല്ലെങ്കിൽ പഠനത്തിന്റെ ഭാഗമായിരിക്കുകയില്ല',
  'gru-add-to.collections-info':
    'ഇവിടെ പറഞ്ഞിരിക്കുന്ന ശേഖരങ്ങൾ <b> മറ്റൊരു പാഠഭാഗമോ പഠനമോ അല്ല',
  ...
  'qz-assessment-confirmation.continue': 'തുടരുക',
  'qz-assessment-confirmation.start': 'ആരംഭിക്കുക!',
  'qz-assessment-confirmation.no-content-info-message':
    'ഈ {{collectiontype}} വികസത്തിലുണ്ട്. പിന്നീട് വീണ്ടും പരിശോധിക്കുക.',
  'gru-submit-confirmation.title':
    'എല്ലാം സമർപ്പിക്കാൻ നിങ്ങൾ ആഗ്രഹിക്കുന്നുവെന്ന് ഉറപ്പാണോ?',
  ...
  'gru-submit-confirmation.confirm': 'എല്ലാം സമർപ്പിക്കുക',
  ...
  'qz-open-ended.characterLimit': 'പ്രതീക പരിധി',
  'qz-question-viewer.answer': 'ഉത്തരം',
  'qz-question-viewer.previous': 'മുമ്പത്തെ',
  'qz-question-viewer.question': 'ചോദ്യം',
  'qz-true-false.instructions':
    'ദയവായി ശരിയായ ഉത്തരം തിരഞ്ഞെടുത്ത്  "{{action}} " ക്ലിക്കുചെയ്യുക.',
  'qz-true-false.true': 'ശരി',
  'qz-true-false.false': 'തെറ്റായ',
  'qz-reorder.instructions':
    'കൃത്യമായ ക്രമത്തിൽ ഉത്തരങ്ങൾ പുനഃക്രമീകരിക്കുക, തുടർന്ന്  "{{action}} " ക്ലിക്കുചെയ്യുക.',
  'qz-navigation.view-report': 'റിപ്പോർട്ട് കാണുക',
  'qz-player-footer.usage-report': 'ഉപയോഗ റിപ്പോർട്ട്',
  ...
  'gru-data-picker.study-time': 'സമയം',
  ...
  'gru-metrics-sub-header.study-time': 'സമയം',
  'qz-assessment-report.open-ended': 'സൌജന്യ പ്രതികരണ ചോദ്യങ്ങൾ',
  'qz-assessment-report.questions': 'ചോദ്യങ്ങൾ',
  'qz-assessment-report.resources': 'വിഭവങ്ങൾ',
  'qz-assessment-report.qz-summary.total-time-spent': 'ചെലവഴിച്ച മൊത്തം സമയം',
  ...
  'reports.qz-table-view.student': 'വിദ്യാർത്ഥി',
  'reports.qz-table-view.reaction': 'പ്രതികരണം',
  'reports.qz-table-view.reactions': 'പ്രതികരണങ്ങൾ',
  'reports.qz-table-view.score': 'സ്കോർ',
  'reports.qz-table-view.scores': 'സ്കോറുകൾ',
  'reports.qz-table-view.study-time': 'സമയം',
  'reports.qz-table-view.time-spent': 'ചിലവഴിച്ച സമയം',
  'reports.qz-table-view.totals': 'മൊത്തം',
  'qz-emotion-picker.react-to-resource': 'ഈ വിഭവത്തോട് പ്രതികരിക്കുക',
  ...
  'qz-rich-text-editor.bold': 'ധീരമായ',
  'qz-rich-text-editor.expression': 'എക്സ്പ്രഷൻ',
  'qz-rich-text-editor.italic': 'ഇറ്റാലിക്',
  'qz-rich-text-editor.subscript': 'സബ്സ്ക്രിപ്റ്റ്',
  'qz-rich-text-editor.superscript': 'സൂപ്പർസ്ക്രിപ്റ്റ്',
  'qz-rich-text-editor.underline': 'അടിവരയിടുക',
  'qz-rich-text-editor.expressions-panel.tabs.calculus': 'കാൽക്കുലസ്',
  'qz-rich-text-editor.expressions-panel.tabs.greek-letters':
    'ഗ്രീക്ക് അക്ഷരങ്ങൾ',
  'qz-rich-text-editor.expressions-panel.tabs.layout': 'ലേഔട്ട്',
  'qz-rich-text-editor.expressions-panel.tabs.relation': 'ബന്ധം',
  'qz-rich-text-editor.expressions-panel.tabs.set-theory': 'സെറ്റ് സിദ്ധാന്തം',
  'qz-rich-text-editor.expressions-panel.tabs.symbols': 'ചിഹ്നങ്ങൾ',
  'qz-rich-text-editor.expressions-panel.tabs.trigonometry': 'ത്രികോണമിതി',
  'qz-rich-text-editor.expressions-panel.insert-expression': 'തിരുകുക',
  'qz-rich-text-editor.expressions-panel.update-expression': 'അപ്ഡേറ്റ്',
  ...
  'gru-settings-edit.performance': 'വിദ്യാർത്ഥികൾ അവരുടെ പ്രകടനം കാണും',
  ...
  'gru-tour.overview.stepSix.description':
    'വിദ്യാർത്ഥികൾക്ക് തൽസമയ മൂല്യനിർണ്ണയം ആരംഭിക്കുന്നതിന് ഓരോ മൂല്യനിർണയത്തിന്റെയും ഇടതുവശത്തുള്ള  "തൽസമയ " ഐക്കണിൽ ക്ലിക്ക് ചെയ്യുക. <br> <br> . <br> <br> <i class =  "real-time-icon ">',
  ...
  'gru-tour.home.stepOne.title': 'നിങ്ങളുടെ ഹോംപേജ്',
  'gru-tour.home.stepOne.description':
    'നിങ്ങളുടെ gooru ഹോംപേജിലേക്ക് സ്വാഗതം! ഇവിടെ നിങ്ങൾ gooru ൽ സൃഷ്ടിക്കുന്ന ക്ലാസ്റൂമുകളുടെ ഒരു പട്ടിക കണ്ടെത്താൻ കഴിയും. വിദ്യാർത്ഥികളുമായി ഉള്ളടക്കം നേരിട്ട് പങ്കിടാൻ ക്ലാസ് മുറികൾ അനുവദിക്കുന്നു. നിങ്ങൾ gooru ഐക്കണിൽ ക്ലിക്കുചെയ്ത് എല്ലായ്പ്പോഴും നിങ്ങളുടെ ഹോംപേജിലേക്ക് മടങ്ങാൻ കഴിയും.',
  'gru-tour.home.stepTwo.title':
    'നിങ്ങൾ പഠിപ്പിക്കുന്ന അല്ലെങ്കിൽ ചേരുന്ന ക്ലാസുകൾ',
  'gru-tour.home.stepTwo.description':
    'നിങ്ങൾ ഈ ക്ലാസ് വർഷം പഠിപ്പിക്കുന്ന അല്ലെങ്കിൽ കൂട്ടിച്ചേർത്ത ഏതെങ്കിലും ക്ലാസ്റൂമുകൾ ഇവിടെ സജീവ ക്ലാസ് റൂമുകളിൽ പ്രത്യക്ഷപ്പെടും.',
  'gru-tour.home.stepThree.title': 'മുമ്പത്തെ ക്ലാസുകൾ',
  'gru-tour.home.stepThree.description':
    'കഴിഞ്ഞ ക്ലാസുകളിൽ നിങ്ങൾ സൃഷ്ടിച്ച അല്ലെങ്കിൽ കൂട്ടിച്ചേർത്ത ഏതെങ്കിലും ക്ലാസ്റൂമുകൾ ആർക്കൈവുചെയ്ത ക്ലാസ് മുറികളിൽ കണ്ടെത്താനാകും. ഈ ക്ലാസുകളിൽ ഉപയോഗിക്കുന്ന ഉള്ളടക്കം നിങ്ങളുടെ പ്രൊഫൈലിൽ കണ്ടെത്താനാകും, ഈ സ്കൂൾ വർഷത്തെ പുതിയ ക്ലാസ്മുറികൾക്ക് ഇത് വീണ്ടും ഏൽപ്പിക്കാനാകും.',
  'gru-tour.home.stepFour.title': 'ഒരു ക്ലാസ്റൂം സൃഷ്ടിക്കുക',
  'gru-tour.home.stepFour.description':
    'ഒരു പുതിയ ക്ലാസ്റൂം സൃഷ്ടിക്കാൻ ഇവിടെ ക്ലിക്കുചെയ്യുക. വിദ്യാർത്ഥികളുമായി പങ്കുചേരാൻ ഉള്ളടക്കം ഉണ്ടെങ്കിൽ, ഒരു ക്ലാസ് റൂമിനാൽ നിങ്ങൾ അവർക്ക് അത് നൽകും.',
  'gru-tour.home.stepFive.title': 'നിങ്ങളുടെ പ്രൊഫൈൽ',
  'gru-tour.home.stepFive.description':
    'ഇത് നിങ്ങളുടെ പ്രൊഫൈലാണ്. gooru ൽ നിങ്ങൾ സൃഷ്ടിച്ച അല്ലെങ്കിൽ റീമിക്സ് ഉള്ളടക്കം ആക്സസ് ചെയ്യാൻ എപ്പോൾ വേണമെങ്കിലും നിങ്ങളുടെ പ്രൊഫൈലിൽ ക്ലിക്കുചെയ്യുക.',
  'assign-students.assessment-settings': 'വിലയിരുത്തൽ ക്രമീകരണങ്ങൾ',
  'assign-students.assign-assessment-modal-title':
    'വിദ്യാർത്ഥികൾക്ക് വിലയിരുത്തൽ നൽകുക',
  'assign-students.available-from': 'ഇതിൽ നിന്നും ലഭ്യമാണ്:',
  'assign-students.date': 'തീയതി',
  'assign-students.due-date': 'അവസാന തീയതി:',
  'assign-students.time': 'സമയം',
  'assign-students.title': 'തലക്കെട്ട്: {{title}}',
  'assign-students.search-by-name': 'പേര് ഉപയോഗിച്ച് തിരയുക',
  'assign-students.select-all': 'എല്ലാം തിരഞ്ഞെടുക്കുക ({{count}})',
  'assign-students.select-students': 'വിദ്യാർത്ഥി (കൾ) തിരഞ്ഞെടുക്കുക',
  'assign-students.selected-count':
    '{{total}} എന്നതിന്റെ {{chosen}} തിരഞ്ഞെടുത്തത്',
  'assign-students.students-roster': 'വിദ്യാർത്ഥികളുടെ റസ്റ്റർ',
  'assignments-view.actions': 'പ്രവർത്തനങ്ങൾ',
  'assignments-view.attempts': 'ശ്രമങ്ങൾ അവശേഷിക്കുന്നു',
  'assignments-view.date': 'തീയതി അസൈൻ ചെയ്തു',
  'assignments-view.dateModified': 'പുതുക്കിയ തീയതി',
  'assignments-view.dueDate': 'അവസാന തീയതി',
  'assignments-view.search': 'തിരയൽ ...',
  'assignments-view.standards': 'മാനദണ്ഡങ്ങൾ',
  'assignments-view.studentsAssigned': 'വിദ്യാർത്ഥികളെ നിയമിച്ചു',
  'assignments-view.title': 'ശീർഷകം',
  'assignment-details.assign': 'നിയമിക്കുക',
  'assignment-details.answer-key': 'ഉത്തരം കീ',
  'assignment-details.attempts': 'ശ്രമങ്ങൾ',
  'assignment-details.attempts-left':
    '<b> ശ്രമങ്ങൾ അവശേഷിക്കുന്നു: </b> {{count =}',
  'assignment-details.lastAttempt': '<b> അവസാന ശ്രമം: </b>',
  'assignment-details.launch': 'സമാരംഭിക്കുക',
  'assignment-details.learningObjective': 'പഠന ലക്ഷ്യം',
  'assignment-details.navigation': 'നാവിഗേഷൻ',
  'assignment-details.no-attempts': 'ശ്രമങ്ങളൊന്നും ശേഷിക്കുന്നില്ല',
  'assignment-details.off': 'ഓഫ്',
  'assignment-details.on': 'ഓണാണ്',
  'assignment-details.preview': 'പ്രിവ്യൂ',
  'assignment-details.questions': 'ചോദ്യങ്ങൾ',
  'assignment-details.redo': 'തയ്യാറായ',
  'assignment-details.show-score': 'സ്കോർ കാണിക്കുക',
  'assignment-details.view-report': 'റിപ്പോർട്ട് കാണുക',
  'qz-submission-format.textbox': 'ടെക്സ്റ്റ് ബോക്സ്',
  'qz-submission-format.upload': 'അപ്ലോഡ് ചെയ്യുക (url അല്ലെങ്കിൽ file)',
  'qz-rubric-creation.from-web': 'വെബിൽ നിന്ന്',
  'qz-rubric-creation.from-computer': 'നിങ്ങളുടെ കമ്പ്യൂട്ടറിൽ നിന്ന്',
  'qz-rubric-creation.url': 'url',
  'qz-rubric-creation.qz-preview-url.add': 'മുകളിൽ ഒരു റൂട്ട് ചാർപ്പ് ചേർക്കുക',
  'qz-rubric-creation.qz-category.feedback-guidance': 'ഫീഡ് മാർഗനിർദ്ദേശം',
  'qz-rubric-creation.qz-category.feedback-guidance-placeholder':
    'ഉദാ. നിങ്ങൾ ഈ വിഭാഗം അവലോകനം ചെയ്യുന്നതിനാൽ, രചയിതാവിന്റെ ലക്ഷ്യത്തിന് ശ്രദ്ധാലുവായി ശ്രദ്ധ നൽകുക',
  'qz-rubric-creation.qz-category.required-feedback': 'ആവശ്യമായ ഫീഡ്ബാക്ക്',
  'qz-rubric-creation.qz-category.scoring': 'സ്കോർ ചെയ്യുന്നു',
  'qz-rubric-creation.qz-category.title': 'വിഭാഗ ശീർഷകം',
  'qz-rubric-creation.qz-category.title-placeholder':
    'ഉദാ. വ്യാകരണം, ആശയങ്ങൾ, പ്രബന്ധം',
  'qz-rubric-creation.qz-category.new-category': 'പുതിയ വിഭാഗം ചേർക്കുക',
  'qz-rubric-creation.qz-category.qz-scoring-levels.basic':
    'ഉദാ. അടിസ്ഥാനപരമായി',
  'qz-rubric-creation.qz-category.qz-scoring-levels.below-basic':
    'ഉദാ. അടിസ്ഥാന അടിസ്ഥാനത്തിൽ',
  'qz-rubric-creation.qz-category.qz-scoring-levels.best': 'മികച്ചത്',
  'qz-rubric-creation.qz-category.qz-scoring-levels.exemplary':
    'ഉദാ. മാതൃകായോഗ്യമാണ്',
  'qz-rubric-creation.qz-category.qz-scoring-levels.levels': 'ലെവലുകൾ',
  'qz-rubric-creation.qz-category.qz-scoring-levels.new-level':
    'പുതിയ തലത്തിലേക്ക് ചേർക്കുക',
  'qz-rubric-creation.qz-category.qz-scoring-levels.points': 'പോയിന്റുകൾ',
  'qz-rubric-creation.qz-category.qz-scoring-levels.proficient': 'ഔട്ട്. വർധന',
  'qz-rubric-creation.qz-category.qz-scoring-levels.worst': 'ഏറ്റവും മോശം',
  'over-all-score.title': 'മൊത്തം സ്കോർ & ഫീഡ്ബാക്ക്',
  'over-all-score.total-points': 'സാധ്യമായ മൊത്തം പോയിന്റുകൾ',
  'over-all-score.points': 'പോയിന്റുകൾ',
  'over-all-score.feedback-guidance-placeholder':
    'ഉദാ. നിങ്ങൾ ഈ ലേഖനം മുഴുവനായും പരിശോധിക്കുന്നതിനനുസരിച്ച്, ആദ്യം മുതൽ അവസാനം വരെ പ്രതിബിംബിയുടെ ശബ്ദത്തെക്കുറിച്ച് ഫീഡ്ബാക്ക് നൽകുക',
  'qz-player.resource-format.image_resource': 'ചിത്രം',
  'qz-player.resource-format.text_resource': 'വാചകം',
  'qz-player.resource-format.video_resource': 'വീഡിയോ',
  'qz-player.resource-format.interactive_resource': 'സംവേദനാത്മകം',
  'qz-player.resource-format.webpage_resource': 'വെബ് പേജ്',
  'qz-player.resource-format.audio_resource': 'ഓഡിയോ',
  'qz-player.resource-format.question': 'ചോദ്യം',
  'qz-free-response-viewer.prompt': 'ടാസ്ക് പ്രോംപ്റ്റ്',
  'qz-free-response-viewer.preview-submission': 'പ്രിവ്യൂ സമർപ്പിക്കൽ',
  'qz-free-response-viewer.full-rubric': 'പൂർണ്ണമായ റബ്രിക്ക്',
  'qz-free-response-viewer.total-score': 'മൊത്തം സ്കോർ',
  'qz-free-response-viewer.points': 'പോയിന്റുകൾ'
};
