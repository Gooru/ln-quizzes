...
moduleForService('service:quizzes/configuration', 'Unit | Service | quizzes/configuration', {
...
test('loadConfiguration', function(assert) {
  ...
  service.set('configurationAdapter', Ember.Object.create({
    loadConfiguration: function(key) {
      assert.equal(key, 'localhost-quizzes', 'loadConfiguration function was called' );
