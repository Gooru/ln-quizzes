...
test('Layout', function (assert) {
  ...
  andThen(function () {
    ...
    andThen(function () {
      ...
      T.exists(assert, $playerContainer.find('.qz-main .qz-navigation'), 'Missing player navigation');
      T.exists(assert, $playerContainer.find('.qz-main .qz-viewer'), 'Missing player viewer');
      T.exists(assert, $playerContainer.find('.qz-aside .qz-navigator'), 'Missing player navigator');
    });
  });
});
