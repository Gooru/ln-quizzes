...
moduleForComponent('player/questions/qz-open-ended', 'Unit | Component | player/questions/qz open ended', {
...
test('isAnswerCompleted', function(assert) {
  ...
  assert.notOk(component.get('isAnswerCompleted'), 'Is answer completed should be false');
  component.set('answer', 'answer');
  assert.ok(component.get('isAnswerCompleted'), 'Is answer completed should be true');
});
...
test('charactersLeft', function(assert) {
  ...
  assert.equal(component.get('charactersLeft'), 6, 'There should be 5 characters left');
  component.set('answer', 'ans');
  assert.equal(component.get('charactersLeft'), 3, 'There should be 5 characters left');
  component.set('answer', 'answer');
  assert.equal(component.get('charactersLeft'), 0, 'There should be 5 characters left');
});
