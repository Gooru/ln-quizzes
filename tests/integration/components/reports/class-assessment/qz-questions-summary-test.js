...
moduleForComponent('reports/class-assessment/qz-questions-summary', 'Integration | Component | reports/class assessment/qz questions summary', {
  integration: true
});
...
test('it renders all questions', function (assert) {
  ...
  this.render(hbs`{{reports/class-assessment/qz-questions-summary data=questionsData}}`);
