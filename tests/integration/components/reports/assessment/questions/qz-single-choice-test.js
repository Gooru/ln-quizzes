...
test('Single Choice Correct Answer', function(assert) {
  ...
  this.render(hbs`{{reports/assessment/questions/qz-single-choice question=question showCorrect=showCorrect}}`);
  const $component = this.$(); //component dom element
  const $singleChoice = $component.find('.reports.assessment.questions.qz-single-choice');
...
test('Single Choice Your Answer Incorrect', function(assert) {
  ...
  this.render(hbs`{{reports/assessment/questions/qz-single-choice question=question}}`);
  const $component = this.$(); //component dom element
  const $singleChoice = $component.find('.reports.assessment.questions.qz-single-choice');
  T.exists(assert, $singleChoice, 'Missing single choice component');
...
test('Single Choice anonymous', function(assert) {
  ...
  this.render(hbs`{{reports/assessment/questions/qz-single-choice question=question anonymous=true}}`);
  const $component = this.$(); //component dom element
  const $singleChoice = $component.find('.reports.assessment.questions.qz-single-choice');
  T.exists(assert, $singleChoice, 'Missing single choice component');
