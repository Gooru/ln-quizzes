...
moduleForComponent('editor/assessment/qz-fixed-footer', 'Integration | Component | editor/assessment/qz fixed footer', {
  integration: true
});
...
test('it renders', function(assert) {
  ...
  this.render(hbs`{{editor/assessment/qz-fixed-footer footerActions=footerActions}}`);
